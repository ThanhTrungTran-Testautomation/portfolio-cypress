...
function parseSplitInputs(env = {}, configEnv = {}) {
  ...
  let ciName
  console.log('env.GITHUB_ACTIONS:', env.GITHUB_ACTIONS)
  console.log('env.CI_NODE_INDEX:', env.CI_NODE_INDEX)
  console.log('env.CI_NODE_TOTAL:', env.CI_NODE_TOTAL)
  console.log('env.CIRCLECI:', env.CIRCLECI)
  ...
  console.log('Split index:', SPLIT_INDEX)
